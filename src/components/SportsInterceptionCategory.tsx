...
export const SportsInterceptionCategory = () => {
  // 体育拦截分类数据
  const categoryData = [
    { site: '1', sportAmount: 596.9, sportPercent: 7, batchAmount: 226.5, batchPercent: 13, negativeAmount: 138.1, negativePercent: 10, shipmentAmount: 189.1, shipmentPercent: 13, chickenAmount: 6.6, chickenPercent: 3, fastConsultAmount: 0.7, fastConsultPercent: 0, sandwichAmount: 5.4, otherAmount: null },
    { site: '2', sportAmount: 606.3, sportPercent: 7, batchAmount: 76.4, batchPercent: 4, negativeAmount: 49.2, negativePercent: 4, shipmentAmount: 15.4, shipmentPercent: 1, chickenAmount: 18.3, chickenPercent: 8, fastConsultAmount: 9.6, fastConsultPercent: 5, sandwichAmount: 2.2, otherAmount: null },
    { site: '3', sportAmount: 481.3, sportPercent: 5, batchAmount: 182.4, batchPercent: 10, negativeAmount: 84.7, negativePercent: 6, shipmentAmount: 43.1, shipmentPercent: 3, chickenAmount: 6.2, chickenPercent: 3, fastConsultAmount: 0.2, fastConsultPercent: 0, sandwichAmount: 2.9, otherAmount: null },
    { site: '4', sportAmount: 2984.2, sportPercent: 33, batchAmount: 534.4, batchPercent: 30, negativeAmount: 513.4, negativePercent: 39, shipmentAmount: 683.7, shipmentPercent: 48, chickenAmount: 63.3, chickenPercent: 27, fastConsultAmount: 38.8, fastConsultPercent: 21, sandwichAmount: 13.2, otherAmount: null },
    { site: '5', sportAmount: 87.4, sportPercent: 1, batchAmount: 22.9, batchPercent: 1, negativeAmount: 17.3, negativePercent: 1, shipmentAmount: 9.7, shipmentPercent: 1, chickenAmount: 2.1, chickenPercent: 1, fastConsultAmount: 0.0, fastConsultPercent: 0, sandwichAmount: 1.0, otherAmount: null },
    { site: '7', sportAmount: 740.6, sportPercent: 8, batchAmount: 180.8, batchPercent: 10, negativeAmount: 146.0, negativePercent: 11, shipmentAmount: 116.9, shipmentPercent: 8, chickenAmount: 2.2, chickenPercent: 1, fastConsultAmount: 4.8, fastConsultPercent: 3, sandwichAmount: 2.3, otherAmount: null },
    { site: '8', sportAmount: 378.6, sportPercent: 4, batchAmount: 66.2, batchPercent: 4, negativeAmount: 90.5, negativePercent: 7, shipmentAmount: 46.6, shipmentPercent: 3, chickenAmount: 3.8, chickenPercent: 2, fastConsultAmount: 0.4, fastConsultPercent: 0, sandwichAmount: 0.2, otherAmount: null },
    { site: '6+9', sportAmount: 1040.0, sportPercent: 12, batchAmount: 157.1, batchPercent: 9, negativeAmount: 130.4, negativePercent: 10, shipmentAmount: 96.6, shipmentPercent: 7, chickenAmount: 41.5, chickenPercent: 18, fastConsultAmount: 6.6, fastConsultPercent: 4, sandwichAmount: 2.0, otherAmount: null },
    { site: 'BD+XK', sportAmount: 932.2, sportPercent: 10, batchAmount: 163.4, batchPercent: 9, negativeAmount: 86.8, negativePercent: 7, shipmentAmount: 163.4, shipmentPercent: 12, chickenAmount: 45.6, chickenPercent: 19, fastConsultAmount: 114.0, fastConsultPercent: 61, sandwichAmount: 7.5, otherAmount: null },
    { site: '综合', sportAmount: 1085.3, sportPercent: 12, batchAmount: 162.6, batchPercent: 9, negativeAmount: 62.5, negativePercent: 5, shipmentAmount: 52.3, shipmentPercent: 4, chickenAmount: 44.6, chickenPercent: 19, fastConsultAmount: 10.4, fastConsultPercent: 6, sandwichAmount: 11.4, otherAmount: null }
  ];
        ...
        <div className="bg-white rounded-lg p-6">
          <div className="space-y-3 text-gray-700">
            <div className="flex items-start">
              ...
              <span>体育打水为主要占比，达到<span className="font-semibold text-blue-600">64.22%</span>，其次为批量打水占比为<span className="font-semibold text-blue-600">12.75%</span>，出货以及打负/租卖号/其他打水占比分别为<span className="font-semibold text-blue-600">10.18%</span>和<span className="font-semibold text-blue-600">9.48%</span>。</span>
            </div>
            <div className="flex items-start">
              <span className="text-blue-600 mr-2">●</span>
