    ...
    <div className="bg-white rounded-lg p-16 mb-10 relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-amber-50 rounded p-6 border-l-4 border-amber-500 flex-1">
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-700 leading-relaxed text-base">
                    系统处于初级，跨站融合、策略升级等需投入资源，在'解决当下问题'与'长期合理性'之间需平衡，短期难显成效，需要韧性。
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-amber-50 rounded p-6 border-l-4 border-amber-500 flex-1">
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1">
                  <h4 className="text-xl font-bold text-gray-900 mb-3">风险挑战（关键考虑点）</h4>
                  <p className="text-gray-700 leading-relaxed text-base">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-blue-50 rounded p-6 border-l-4 border-blue-600">
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1">
                  <h4 className="text-xl font-bold text-gray-900 mb-3">对人的依赖会越来越低</h4>
                  <p className="text-gray-700 leading-relaxed text-base">
      ...
      <div className="mb-8">
        <div className="bg-white rounded p-8 border-2 border-gray-200">
          ...
          <div className="mb-8">
            <span className="text-gray-700 text-xl">存在较大影响及风险，将采取分阶段推进方式，在风险可控和有效的前提下，完成体系变革。</span>
          </div>
