  ...
  return (
    <div className="bg-white rounded-lg p-16 mb-10 relative">
      ...
      <div className="mb-8 flex items-center justify-between border-b-4 border-blue-600 pb-4">
        <h1 className="text-5xl font-bold text-gray-800">3.1 FK全局说明</h1>
            ...
            <div className="bg-blue-50 rounded-lg p-6 border-l-4 border-blue-600">
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-700 leading-relaxed text-base">
                    过去侧重防御，缺防范套利和作弊的策略，缺提效的工具，流程也有缺陷，导致员工只依赖个人经验，陷入恶性循环。
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-blue-50 rounded-lg p-6 border-l-4 border-blue-600 flex-1">
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-700 leading-relaxed text-base">
                    涉及多部门且任何策略流程调整（即使改正过往错误做法），都影响会员体验、代理收益和业务及组织稳定
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-blue-50 rounded-lg p-6 border-l-4 border-blue-600">
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-700 leading-relaxed text-base">
                    通过切割权限、背靠背流程机制，并在多环节、多维度识别高危操作、实施监控预警，提升违规成本，几乎消除违规操作空间，构建可靠防护体系。
                  </p>
                </div>
              </div>
            </div>
      ...
      <div className="mb-8">
        <div className="bg-white rounded-lg p-8 border border-blue-200">
          ...
          <div className="mb-8">
            <span className="text-gray-700 text-xl">由于变革会存在较大影响及风险，将采取<span className="text-blue-600">在风险可控和有效的前提下的分阶段推进方式</span>，完成体系变革。</span>
          </div>
