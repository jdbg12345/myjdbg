        ...
        <table className="w-full border-collapse bg-white rounded-lg overflow-hidden">
          ...
          <tbody>
            {[
              ...
              { name: "活动&红利风险", desc: "监控会员领取活动和红利后是否套利", status: "开发中", statusColor: "bg-yellow-100 text-yellow-600", time: "07月底", benefit: "新用户套活动&红利、DL线下红利等拦截率达到90%+" },
              ...
              { name: "关联DL套利", desc: "监控提款会员所属DL刷活跃、凑负盈利、刷新增等行为", status: "方案中", statusColor: "bg-gray-100 text-gray-600", time: "待定", benefit: "质检结果中，错误占比约10%-20%，目标是拦截率达到90%+" },
              ...
              { name: "事件临时配置", desc: "建立应急响应机制，支持突发风险事件的快速配置，如IP、游戏code、DLcode、活动Code等", status: "方案中", statusColor: "bg-gray-100 text-gray-600", time: "待定", benefit: "增强系统应急扩展性" },
