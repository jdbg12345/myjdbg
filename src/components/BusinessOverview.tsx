...
export const BusinessOverview = () => {
  ...
  const progressSchedule = [
    { time: '2025 Q1', stage: '梳理规划', work: '站点摸底，识别痛点，制定变革策略，明确方向与执行框架', current: 已完成 },
    { time: '2025 Q2', stage: '试点落地', work: '关键环节标准化、拦截策略多元化，推动研发与流程逐步落地', current: false },
    { time: '2025 Q3', stage: '成果验证', work: '聚焦试点，收集成果并评估策略有效性，为全站推广提供依据', current: true },
    { time: '2025 Q4', stage: '全站推广', work: '将验证通过的策略在全站点实施；统一跨平台流程与操作标准', current: false },
  ];
      ...
      <div className="bg-white rounded-lg p-8 mb-8 border border-blue-200">
        ...
        <div className="bg-blue-50 rounded-xl p-6 mb-8">
          <p className="text-lg text-blue-900 font-semibold">
            在风控中，“人”是所有问题的根源。长期目标是不依赖“人”，压缩人的操作比重和空间，由系统主导操作与约束，提升风控质量与稳定性，使违规者成本与风险极高，几乎无可操作空间。
          </p>
        </div>
