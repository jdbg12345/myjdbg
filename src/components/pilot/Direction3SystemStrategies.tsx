        ...
        <div className="mb-8">
          <div className="bg-white rounded-xl p-8 shadow-lg border border-gray-200">
            <div className="flex items-center space-x-3 mb-6">
              ...
              <span className="px-4 py-2 rounded-full text-sm font-semibold bg-blue-100 text-blue-600 shadow-sm">试运行</span>
            </div>
        ...
        <div className="mb-8">
          <div className="bg-white rounded-xl p-8 shadow-lg border border-gray-200">
            <div className="flex items-center space-x-3 mb-6">
              ...
              <span className="px-4 py-2 rounded-full text-sm font-semibold bg-blue-100 text-blue-600 shadow-sm">已上线</span>
              <span className="px-4 py-2 rounded-full text-sm font-semibold bg-blue-100 text-blue-600 ml-4 shadow-sm">B/C端打通</span>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-gradient-to-br from-red-50 to-red-100 rounded-xl p-6 border-l-4 border-red-500 shadow-sm">
                <h5 className="font-bold text-red-700 mb-2 text-sm">核心问题</h5>
        ...
        <div className="mb-8">
          <div className="bg-white rounded-xl p-8 shadow-lg border border-gray-200">
            <div className="flex items-center space-x-3 mb-6">
              ...
              <span className="px-4 py-2 rounded-full text-sm font-semibold bg-blue-100 text-blue-600 ml-4 shadow-sm">跨Y+B等全站点打通</span>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-gradient-to-br from-red-50 to-red-100 rounded-xl p-6 border-l-4 border-red-500 shadow-sm">
