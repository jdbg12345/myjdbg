          ...
          <div className="bg-white rounded-lg p-8 border border-blue-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-blue-50 rounded-lg p-6 border border-blue-200">
                ...
                <p className="text-gray-700 text-sm leading-relaxed">提供面向<span className="text-blue-600">真人、彩票及体育（开发中）</span>等多类游戏的一键跨站点"关联下注查询"工具，支持基于核心关联特征<span className="text-blue-600">（IP、设备指纹、虚拟币地址、姓名、手机号、注册域名等）</span>的数据聚合与可视化展示，快速生成完整的关联链路与下注明细</p>
              </div>
              <div className="bg-blue-50 rounded-lg p-6 border border-blue-200">
                <h4 className="font-medium text-blue-700 mb-3 flex items-center">
                  <span className="w-3 h-3 bg-blue-600 rounded mr-3"></span>
