          ...
          <div className="bg-white rounded-lg p-8 border border-blue-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-blue-50 rounded-lg p-6 border border-blue-200">
                ...
                <p className="text-gray-700 text-sm leading-relaxed">卡免费是最典型的套利或藏分手段。目前系统在自动出款及人工审核环节中对此识别不足，仍存在较多遗漏，每月都有损失100万+/月。</p>
              </div>
              <div className="bg-blue-50 rounded-lg p-6 border border-blue-200">
        ...
        <div className="mb-8">
          <div className="bg-white rounded-lg p-8 border border-blue-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-blue-50 rounded-lg p-6 border border-blue-200">
                <h5 className="font-medium text-blue-700 mb-2 text-sm">核心问题</h5>
                <p className="text-gray-700 text-sm leading-relaxed"><span className="text-blue-600">对打、机器下注和算牌</span>等是最常见的套利及作弊手段。当前系统在自动出款和人工审核环节对此识别不足，存在较多遗漏，导致每月<span className="text-blue-600">损失超过100万元</span></p>
              </div>
              <div className="bg-blue-50 rounded-lg p-6 border border-blue-200">
                <h5 className="font-medium text-blue-700 mb-2 text-sm">解决策略</h5>
                ...
                <div className="mx-12 h-full relative">
                  ...
                  <div className="absolute left-12 right-12 h-full flex items-end justify-center pb-8">
                    <div className="flex flex-col items-center relative">
                      ...
                      <div className="text-center mt-4">
                        <div className="text-sm text-gray-600 mt-1">380单 (22.1%)</div>
                      </div>
                    </div>
                  </div>
                </div>
