        ...
        <div className="bg-gray-50 rounded-lg p-6">
          <div className="bg-white p-6 rounded-lg border border-gray-200">
              ...
              <div className="ml-8 h-full relative">
                ...
                <div className="absolute left-0 right-0 h-full flex items-end justify-center pb-4">
                  <div className="flex flex-col items-center relative">
                    <div className="absolute -top-8 text-sm font-semibold text-blue-600">25%</div>
                    <div className="w-24 bg-blue-500 rounded-t" style={{ height: '100px' }}></div>
                    <div className="text-center mt-3">
                      <div className="text-sm font-medium text-gray-700">400单</div>
                      <div className="text-sm text-gray-600">电子卡免费</div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="flex justify-center space-x-8">
              ...
              <div className="flex items-center space-x-2">
                <span className="text-sm text-gray-600">问题率: 25%</span>
              </div>
            </div>
