                  ...
                  <table className="w-full border-collapse">
                    ...
                    <tbody>
                      {[
                        ...
                        { platform: '金宝博（188）', display: '提款时提示"账户尚未满足流水要求"；可查看"可提款金额"和"未完成流水"，回传速度极快' },
                        { platform: '万博（ManbetX）', display: '提款界面显示"还需完成 XX元"；并有实时更新流水，显示不同场馆流水及剩余差额' },
                        { platform: '竞博（IM）', display: '提款界面直接显示可提现金额' },
                        { platform: '易游（M6)', display: '提款界面明确显示"还需完成XX元投注额"' },
                        { platform: '雷竞技（Raybet）', display: '提款界面提示"需完成XX元投注"' },
