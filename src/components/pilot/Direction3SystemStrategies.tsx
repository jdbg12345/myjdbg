      ...
      <div className="mb-4">
        <div className="bg-white rounded-lg p-8 mb-8 border border-blue-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="bg-blue-50 rounded-lg p-6">
                <h5 className="font-medium text-blue-700 mb-2 text-sm">核心问题</h5>
                <p className="text-gray-700 text-sm leading-relaxed"><span className="text-blue-600">对打、机器下注和算牌</span>等是最常见的套利手段。当前系统在自动出款和人工审核环节对此识别不足</p>
              </div>
              <div className="bg-blue-50 rounded-lg p-6">
                <h5 className="font-medium text-blue-700 mb-2 text-sm">解决策略</h5>
      ...
      <div className="mb-4">
        <div className="bg-white rounded-lg p-8 mb-8 border border-blue-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="bg-blue-50 rounded-lg p-6">
                <h5 className="font-medium text-blue-700 mb-2 text-sm">核心问题</h5>
                <p className="text-gray-700 text-sm leading-relaxed"><span className="text-blue-600">移分</span>等是最常见的套利手段。当前系统在自动出款和人工审核对此识别不足 </p>
              </div>
              <div className="bg-blue-50 rounded-lg p-6">
                <h5 className="font-medium text-blue-700 mb-2 text-sm">解决策略</h5>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="bg-blue-50 rounded-lg p-6">
                ...
                <div className="text-gray-700 text-sm leading-relaxed space-y-2">
                  ...
                  <div className="flex items-start">
                    <span className="text-blue-600 mr-2">•</span>
                    <span><span className="font-medium text-blue-600">人工计算错误</span>：由于系统计算流水不可用，人员<span className="text-blue-600">只能手动计算</span>。但规则复杂且涉及多个页面和数据，实际操作中差异较大，<span className="text-red-600">既耗时繁琐，又导致每月约1万笔订单（约占5%）因流水错误引发出款损失，金额约为50万元</span></span>
        ...
        <div className="bg-white rounded-lg p-8 mb-8 border border-blue-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="bg-blue-50 rounded-lg p-6">
                ...
                <p className="text-gray-700 text-sm leading-relaxed">2、人工每周、每月从场馆的杀率、流水占比/游戏/玩法的杀率、流水占比去评估异常程度。以及从站点场馆的净利率(包含红利返水)/游戏/玩法去评估异常程度</p>
