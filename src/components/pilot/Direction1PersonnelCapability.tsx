    ...
    统计周期：Y123579上线日期后到9月30
        ...
        <div className="mb-12">
          ...
          <div className="bg-white rounded-lg p-8 mb-8 border border-blue-200">
            ...
            <p className="text-gray-700 text-sm leading-relaxed"><span className="text-blue-600">通过派单机制的调整，外包渠道的订单量由 66,423 单降至 24,511 单，下降了 63.10%；远程渠道的订单量由 82,733 单降至 29,431 单，下降了 64.44%，整体实现了低效渠道订单量的显著压缩。
          ...
          <div className="bg-white rounded-lg p-8 mb-8 border border-blue-200">
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center space-x-3 flex-1">
                ...
                <span className="px-4 py-2 rounded text-sm font-medium bg-blue-100 text-blue-600 ml-4">已上线</span>
                <span className="px-4 py-2 rounded text-sm font-medium bg-blue-100 text-blue-600 ml-4">Y1-Y9</span>
              </div>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-blue-50 rounded-lg p-6 border border-blue-200">
