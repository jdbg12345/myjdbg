      ...
      <div className="bg-white rounded-xl p-8 mb-8 border border-blue-200 shadow-md">
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center space-x-3">
            ...
            <h2 className="text-2xl font-semibold text-gray-800">优化【审核问题-质量较差】</h2>
          </div>
          <div className="text-gray-600 text-lg">
          <p className="text-gray-700 text-base leading-relaxed">从<span className="text-blue-600">派单策略改变、审核流程优化、风险分数调优</span>等三个维度进行优化 </p>
        </div>
        </div>
          ...
          <div className="bg-white rounded-lg p-8 mb-8 border border-blue-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-blue-50 rounded-lg p-6 border border-blue-200">
                ...
                <p className="text-gray-700 text-sm leading-relaxed">以金额作为分单依据，未考虑订单难度及人员能力匹配，导致部分高风险订单被分配至远程或外包，而其<span className="text-blue-600">差错率较总部高出约2～3倍，由此带来超过100万+/月的损失</span></p>
              </div>
              <div className="bg-blue-50 rounded-lg p-6 border border-blue-200">
                <h4 className="font-medium text-blue-700 mb-3 flex items-center">
                  <span className="w-3 h-3 bg-blue-600 rounded mr-3"></span>
                ...
                <p className="text-gray-700 text-sm leading-relaxed">引入订单风险评分机制，将派单从<span className="text-blue-600">"仅按金额"升级为"按风险分数+金额"</span>，确保中高风险订单由经验丰富的审核员处理，实现人单匹配最优分配。</p>
              </div>
              <div className="bg-blue-50 rounded-lg p-6 border border-blue-200">
                <h4 className="font-medium text-blue-700 mb-3 flex items-center">
                  <span className="w-3 h-3 bg-blue-600 rounded mr-3"></span>
