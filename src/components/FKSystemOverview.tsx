    ...
    <div className="bg-white rounded-lg p-16 mb-10 relative">
      ...
      <div className="mb-8 border border-blue-200 rounded-lg p-8">
        <div className="flex items-center space-x-4 mb-8">
          ...
          <div>
            <h2 className="text-3xl font-bold text-gray-900">会员FK能力变化概览</h2>
            <span className="text-gray-700 text-xl">会员侧:<span className="text-blue-600">防御型策略 → 多维度策略（防御+套利+作弊）</span>，降低系统直接出款风险；内控侧:<span className="text-blue-600">增强了违规管控能力</span></span>
          </div>
        </div>
            ...
            <div className="bg-blue-50 rounded-lg p-6 border border-blue-200">
              ...
              <ul className="space-y-2 text-sm text-gray-700">
                ...
                <li className="flex justify-between items-center">
                  ...
                  <span className="px-2 py-1 rounded text-xs font-medium bg-gray-100 text-green-600">已上线</span>
                </li>
                <li className="flex justify-between items-center">
                  <div className="flex items-center space-x-2">
                    <span className="px-2 py-1 rounded text-xs font-medium bg-green-100 text-green-600">Q3-新增</span>
      ...
      <div className="border border-blue-200 rounded-lg p-8 mb-8">
        <div className="flex items-center space-x-4 mb-8">
            ...
            <div>
              ...
              <span className="text-gray-700 text-xl">从<span className="text-blue-600">审核机制、系统策略、风控工具、异常监控</span>等方向进行全面升级</span>
            </div>
        </div>
