        ...
        <div className="bg-gradient-to-br from-gray-50 to-blue-50 rounded-xl p-10 border border-gray-200 shadow-lg">
          <div className="flex justify-center">
            <svg viewBox="0 0 1600 550" className="w-full max-w-6xl h-[500px]">
              ...
              <g>
                <ellipse cx="660" cy="325" rx="170" ry="40" fill="url(#bubbleGradient)" stroke="#2563eb" strokeWidth="2" filter="url(#nodeShadow)"/>
                <text x="660" y="330" textAnchor="middle" fill="white" fontSize="18" fontWeight="600">
                  变化：升级为按分数和金额派单
                </text>
              </g>
