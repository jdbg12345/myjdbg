  ...
  return (
    <div className="bg-white rounded-lg p-16 mb-10 relative">
      ...
      <div className="mb-16">
        ...
        <div className="bg-gray-100 rounded-xl p-10 border border-gray-200">
      ...
      <div className="mb-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="bg-white rounded-xl p-6">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-gradient-to-r from-blue-50 to-gray-100 rounded-xl p-5 border border-gray-200">
                  <h6 className="font-bold text-gray-800 mb-4 text-lg flex items-center">
                    <span className="text-green-500 mr-2">✅</span>
                    游戏作弊类
                  </h6>
        ...
        {/* 内控风险监控 */}
        <div className="bg-gray-50 rounded-xl p-8 mt-8 border border-gray-200">
          <div className="flex items-center justify-between mb-8">
            <div className="flex items-center space-x-4">
              <div className="w-16 h-16 rounded-xl bg-gradient-to-r from-blue-500 to-cyan-500 flex items-center justify-center shadow-lg">
