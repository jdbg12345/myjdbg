        ...
        <div className="bg-white rounded-lg p-8 border border-blue-200">
          <div className="flex justify-center">
            <svg viewBox="0 0 1600 550" className="w-full max-w-6xl h-[450px]">
              ...
              <g>
                <ellipse cx="925" cy="50" rx="140" ry="30" fill="#3b82f6" stroke="#3b82f6" strokeWidth="2"/>
              ...
              <g>
                <ellipse cx="720" cy="380" rx="130" ry="30" fill="#3b82f6" stroke="#3b82f6" strokeWidth="2"/>
                <text x="720" y="385" textAnchor="middle" fill="white" fontSize="20" fontWeight="bold">
                  变化：升级为按分数和金额派单
                </text>
              </g>
              ...
              <text x="1380" y="380" textAnchor="middle" fill="#9ca3af" fontSize="14" fontWeight="bold">不通过</text>
            </svg>
          </div>
        </div>
      </div>
