    ...
    <div className="bg-white rounded-lg p-16 mb-10 relative">
      ...
      <div className="mb-16">
        <div className="flex items-center space-x-3 mb-6">
          ...
          <span className="text-gray-600 text-lg">单人可出款 → 出款监控（+6） + 内控抽检（+7），想违规出款，会非常难且风险大，有效防内外串联；</span>
        </div>
        ...
        <div className="bg-white rounded-lg p-8 border border-blue-200">
          <div className="flex justify-center">
            <svg viewBox="0 0 1600 550" className="w-full max-w-6xl h-[450px]">
              ...
              <g>
                <ellipse cx="925" cy="50" rx="180" ry="40" fill="#3b82f6" stroke="#3b82f6" strokeWidth="2"/>
              ...
              <g>
                <ellipse cx="660" cy="325" rx="170" ry="40" fill="#3b82f6" stroke="#3b82f6" strokeWidth="2"/>
                <text x="660" y="330" textAnchor="middle" fill="white" fontSize="20" fontWeight="bold">
                  变化：升级为按分数和金额派单
                </text>
              </g>
              ...
              <text x="1325" y="275" textAnchor="middle" fill="#9ca3af" fontSize="14" fontWeight="bold">不通过</text>
              <text x="1320" y="200" textAnchor="middle" fill="#9ca3af" fontSize="14" fontWeight="bold">通过</text>
              <text x="1325" y="380" textAnchor="middle" fill="#9ca3af" fontSize="14" fontWeight="bold">不通过</text>
            </svg>
          </div>
        </div>
      </div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <div className="flex items-center space-x-6">
                  <div className="text-lg font-bold text-blue-600">Q1-Q3主要资源在这个方向，变化比较大，持续落地中</div>                 
                </div>
              </div>
            </div>
          </div>
                  ...
                  <div className="space-y-2">
                    <div className="bg-white rounded-lg p-4 border border-blue-200">
                      ...
                      <div className="flex justify-between items-center">
                        <span className="text-gray-600 text-base">状态：<span className="font-bold text-blue-600 text-lg">已上线</span></span>
                        <span className="text-gray-600 text-base">Q3变化：<span className="px-3 py-1 rounded-full bg-blue-100 text-blue-700 font-bold text-lg">增强</span></span>
                      </div>
                    </div>
                    <div className="bg-white rounded-lg p-4 border border-blue-200">
                      <div className="font-bold text-gray-800 text-base mb-2">帐变记录异常</div>
                      <div className="flex justify-between items-center">
                        <span className="text-gray-600 text-base">状态：<span className="font-bold text-yellow-600 text-lg">开发中</span></span>
                        <span className="text-gray-600 text-base">Q3变化：<span className="px-3 py-1 rounded-full bg-blue-100 text-blue-700 font-bold text-lg">新增</span></span>
                      </div>
                    </div>
                    <div className="bg-white rounded-lg p-4 border border-blue-200">
                ...
                <div className="bg-blue-50 rounded-lg p-5">
                  ...
                  <div className="space-y-2">
                    <div className="bg-white rounded-lg p-4 border border-blue-200">
                      ...
                      <div className="flex justify-between items-center">
                        <span className="text-gray-600 text-base">状态：<span className="font-bold text-blue-600 text-lg">已上线</span></span>
                        <span className="text-gray-600 text-base">Q3变化：<span className="px-3 py-1 rounded-full bg-green-100 text-green-700 font-bold text-lg">增强</span></span>
                      </div>
                    </div>
                    <div className="bg-white rounded-lg p-4 border border-blue-200">
                ...
                <div className="bg-blue-50 rounded-lg p-5">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="bg-white rounded-lg p-4 border border-blue-200">
                      ...
                      <div className="flex justify-between items-center">
                        <span className="text-gray-600 text-base">状态：<span className="font-bold text-blue-600 text-lg">运行中</span></span>
                        <span className="text-gray-600 text-base">Q3变化：<span className="px-3 py-1 rounded-full bg-gray-100 text-gray-600 font-bold text-lg">没变</span></span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-green-50 rounded-lg p-5">
                  ...
                  <div className="space-y-2">
                    <div className="bg-white rounded-lg p-4 border border-blue-200">
                      ...
                      <div className="flex justify-between items-center">
                        <span className="text-gray-600 text-base">状态：<span className="font-bold text-orange-600 text-lg">试运行</span></span>
                        <span className="text-gray-600 text-base">Q3变化：<span className="px-3 py-1 rounded-full bg-blue-100 text-blue-700 font-bold text-lg">新增</span></span>
                      </div>
                    </div>
                    <div className="bg-white rounded-lg p-4 border border-blue-200">
                    ...
                    <div className="bg-white rounded-lg p-4 border border-blue-200">
                      ...
                      <div className="flex justify-between items-center">
                        <span className="text-gray-600 text-base">状态：<span className="font-bold text-gray-600 text-lg">方案中</span></span>
                        <span className="text-gray-600 text-base">Q3变化：<span className="px-3 py-1 rounded-full bg-blue-100 text-blue-700 font-bold text-lg">新增</span></span>
                      </div>
                    </div>
                  </div>
